...
q6 = st.selectbox("Do you have a preference for a certain type of accommodation, such as a resort, hotel, vacation rental, or something else?: ",["Select a box","no","hotel","resort","vacation rental","something else(villa)"])
